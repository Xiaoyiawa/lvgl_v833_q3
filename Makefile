...
LDFLAGS ?= -L$(LVGL_DIR)/lib -lavcodec -lavdevice -lavfilter -lavformat -lavutil -lpostproc -lswresample -lswscale -lz -lasound -lfreetype -lwildmidi #-lcurl -lssl -lcrypto
BIN = demo
